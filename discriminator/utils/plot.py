...
def plot_alignment(alignment, title=None, max_len=None, save_path=None):
    ...
    im = ax.imshow(np.rot90(alignment), aspect="auto", origin="lower", interpolation="none")
...
def plot_proiection(embeddings, utterances_per_voice, max_voices=10, save_path=None):
    ...
    fig, ax = plt.subplots(figsize=(6, 4))
    ax.scatter(projected[:, 0], projected[:1], c=colors, marker="o", s=20, label="projections")
    # hide x&y axises
